...
ax.set_title("Figure 1: System Architecture & Experimental Pipeline", fontsize=16, fontweight='bold', pad=30)
...
plt.suptitle('Figure 2: 8B vs 70B Performance Comparison (200 Samples)', fontsize=16, fontweight='bold')
plt.tight_layout()
...
plt.title('Figure 3: Quality Scores Across All Techniques', fontsize=14, fontweight='bold')
...
ax[0].set_title('Figure 4a: Latency Comparison')
...
plt.suptitle('Figure 4: Latency and Token Usage Comparison', fontsize=14, fontweight='bold')
plt.tight_layout()
...
plt.title('Figure 5: Cost Efficiency (Quality per Second)')
...
plt.title('Figure 6: Human vs LLM Judge Score Comparison')
plt.legend()
...
plt.title('Figure 7: Prompt Length vs Quality Performance (8B)')
